    ...
    return (
      <main className="flex min-h-screen items-center justify-center">
        <div className="rounded-xl bg-white px-6 py-4 shadow-sm">
          Cargando TaskFlow — Maycol Siqueros...
        </div>
      </main>
    );
  }
      ...
      <div className="mx-auto grid min-h-screen max-w-6xl items-center gap-10 px-6 py-12 lg:grid-cols-[1.1fr_0.9fr]">
        <section className="text-white">
          ...
          <p className="mt-3 max-w-xl text-md leading-8 text-slate-300">
            Proyecto final del curso de Cloud — desplegado en AWS con Amplify, Elastic Beanstalk y RDS.
          </p>
        </section>

        <section className="rounded-2xl bg-white p-8 shadow-2xl shadow-emerald-950/40">
          ...
          <form className="mt-6 space-y-5" onSubmit={submit}>
            <label className="block">
              ...
              <input
                className="mt-2 w-full rounded-xl border border-slate-300 px-4 py-3 outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
                type="email"
                value={email}
            ...
            <button
              className="w-full rounded-xl bg-emerald-600 px-4 py-3 font-bold text-white transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:bg-slate-400"
              disabled={submitting}
            >
    ...
    <main className="min-h-screen">
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div>
            <p className="text-sm font-semibold text-emerald-600">TaskFlow — Maycol Siqueros</p>
      ...
      <form className="rounded-2xl bg-white p-6 shadow-sm" onSubmit={submit}>
        ...
        <div className="mt-5 space-y-4">
          ...
          <label className="block">
            ...
            <textarea
              className="mt-2 min-h-28 w-full rounded-xl border border-slate-300 px-4 py-3 outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
          ...
          <div className="flex gap-3">
            <button className="rounded-xl bg-emerald-600 px-5 py-3 font-bold text-white transition hover:bg-emerald-700">
      ...
      <div className="rounded-2xl bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 space-y-3">
          ...
          {sortedTasks.map((task) => (
            <article
              className="rounded-xl border border-slate-200 p-4 transition hover:border-blue-200 hover:bg-emerald-50/40"
              key={task.id}
            >
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="flex shrink-0 gap-2">
                  ...
                  <button
                    className="rounded-lg bg-emerald-100 px-3 py-2 text-xs font-bold text-emerald-700 transition hover:bg-blue-200"
